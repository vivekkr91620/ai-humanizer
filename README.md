...
The repository includes a **separate React version** of the frontend in `frontend-react`. The original HTML version is still available for beginners who want a no-build setup. The React app now uses a **modern SaaS-style UI** with polished cards, pill controls, and improved visual hierarchy.
