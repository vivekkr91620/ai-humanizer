      ...
      <main className="container">
        <header className="hero">
          <div>
            ...
            <h1>AI Humanizer</h1>
            <p>
              Turn stiff, robotic drafts into warm, natural language with one
              click. Choose tone, tune intensity, and ship confident copy.
            </p>
          </div>
          <div className="hero-card">
            <div className="hero-card-title">Realtime guidance</div>
            <p>
              Keep your meaning intact while polishing clarity, flow, and
              authenticity.
            </p>
        ...
        <section className="panel">
          <div className="panel-header">
            <h2>Input</h2>
            <p>Paste the text you want to humanize.</p>
          </div>
          <TextInput
            value={text}
            onChange={setText}
        ...
        <section className="panel output-panel">
          <div className="panel-header">
            <h2>Output</h2>
            <p>Your humanized response appears here.</p>
          </div>
